...
__pidataBANK0:
	file	"E:\KTU\Softwares\MP lab\SPI\Master_slave\master.c"
	line	24
...
;; *************** function _main *****************
;; Defined at:
;;		line 17 in file "E:\KTU\Softwares\MP lab\SPI\Master_slave\master.c"
...
l2233:	
;master.c: 18: PORTC=0X00;
	bcf	status, 5	;RP0=0, select bank0
	bcf	status, 6	;RP1=0, select bank0
	clrf	(7)	;volatile
	line	19
;master.c: 19: TRISC=0X00;
	bsf	status, 5	;RP0=1, select bank1
	bcf	status, 6	;RP1=0, select bank1
	clrf	(135)^080h	;volatile
	line	20
;master.c: 20: ANSEL=0X00;
	bsf	status, 5	;RP0=1, select bank3
	bsf	status, 6	;RP1=1, select bank3
	clrf	(392)^0180h	;volatile
	line	21
;master.c: 21: ANSELH=0X00;
	clrf	(393)^0180h	;volatile
	line	22
;master.c: 22: SSPSTAT = 0x00;
	bsf	status, 5	;RP0=1, select bank1
	bcf	status, 6	;RP1=0, select bank1
...
l2237:	
;master.c: 24: char data[10]="sabin";
...
l2239:	
;master.c: 26: {
;master.c: 27: master(&data);
	movlw	(main@data)&0ffh
	fcall	_master
	line	28
	
l2241:	
;master.c: 28: delay(1000);
	movlw	low(03E8h)
	movwf	(?_delay)
	movlw	high(03E8h)
	movwf	((?_delay))+1
...
;; *************** function _master *****************
;; Defined at:
;;		line 7 in file "E:\KTU\Softwares\MP lab\SPI\Master_slave\master.c"
;; Parameters:    Size  Location     Type
...
;; *************** function _delay *****************
;; Defined at:
;;		line 3 in file "E:\KTU\Softwares\MP lab\SPI\Master_slave\master.c"
;; Parameters:    Size  Location     Type
;;  temp            2    0[COMMON] int 
;; Auto vars:     Size  Location     Type
;;		None
