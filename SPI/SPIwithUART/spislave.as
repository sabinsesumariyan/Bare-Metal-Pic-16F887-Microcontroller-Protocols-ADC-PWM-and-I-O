...
;; *************** function _main *****************
;; Defined at:
;;		line 58 in file "E:\KTU\Softwares\MP lab\SPI\SPIwithUART\spislave.c"
...
;;
psect	maintext
	file	"E:\KTU\Softwares\MP lab\SPI\SPIwithUART\spislave.c"
	line	58
...
l2324:	
;spislave.c: 59: PORTB=0X00;
	bcf	status, 5	;RP0=0, select bank0
	bcf	status, 6	;RP1=0, select bank0
	clrf	(6)	;volatile
	line	60
;spislave.c: 60: TRISB=0X00;
	bsf	status, 5	;RP0=1, select bank1
	bcf	status, 6	;RP1=0, select bank1
	clrf	(134)^080h	;volatile
	line	61
;spislave.c: 61: PORTC=0X00;
	bcf	status, 5	;RP0=0, select bank0
	bcf	status, 6	;RP1=0, select bank0
	clrf	(7)	;volatile
	line	62
;spislave.c: 62: TRISC=0X00;
	bsf	status, 5	;RP0=1, select bank1
	bcf	status, 6	;RP1=0, select bank1
	clrf	(135)^080h	;volatile
	line	63
;spislave.c: 63: PORTD=0X00;
	bcf	status, 5	;RP0=0, select bank0
	bcf	status, 6	;RP1=0, select bank0
	clrf	(8)	;volatile
	line	64
...
l2328:	
;spislave.c: 65: TRISD=0X00;
	clrf	(136)^080h	;volatile
	line	66
	
l2330:	
;spislave.c: 66: ANSEL=0X00;
...
l2332:	
;spislave.c: 67: ANSELH=0X00;
	clrf	(393)^0180h	;volatile
	line	68
	
l2334:	
;spislave.c: 68: SSPSTAT=0x00;
	bsf	status, 5	;RP0=1, select bank1
	bcf	status, 6	;RP1=0, select bank1
...
;; *************** function _slave *****************
;; Defined at:
;;		line 46 in file "E:\KTU\Softwares\MP lab\SPI\SPIwithUART\spislave.c"
;; Parameters:    Size  Location     Type
;;		None
;; Auto vars:     Size  Location     Type
;;  i               2    4[COMMON] int 
...
l2304:	
;spislave.c: 47: for(int i=0;i<10;i++)
	clrf	(slave@i)
	clrf	(slave@i+1)
...
l2312:	
;spislave.c: 51: SSPIF = 0;
	bcf	(99/8),(99)&7
	line	52
	
l2314:	
;spislave.c: 52: delay(1000);
	movlw	low(03E8h)
	movwf	(?_delay)
	movlw	high(03E8h)
	movwf	((?_delay))+1
...
;; *************** function _display *****************
;; Defined at:
;;		line 39 in file "E:\KTU\Softwares\MP lab\SPI\SPIwithUART\spislave.c"
;; Parameters:    Size  Location     Type
...
;; *************** function _address *****************
;; Defined at:
;;		line 32 in file "E:\KTU\Softwares\MP lab\SPI\SPIwithUART\spislave.c"
;; Parameters:    Size  Location     Type
;;  data            1    wreg     unsigned char 
;; Auto vars:     Size  Location     Type
;;  data            1    2[COMMON] unsigned char 
...
;; *************** function _type *****************
;; Defined at:
;;		line 25 in file "E:\KTU\Softwares\MP lab\SPI\SPIwithUART\spislave.c"
;; Parameters:    Size  Location     Type
;;		None
;; Auto vars:     Size  Location     Type
;;		None
...
;; *************** function _on *****************
;; Defined at:
;;		line 18 in file "E:\KTU\Softwares\MP lab\SPI\SPIwithUART\spislave.c"
;; Parameters:    Size  Location     Type
;;		None
;; Auto vars:     Size  Location     Type
;;		None
...
;; *************** function _pulse *****************
;; Defined at:
;;		line 11 in file "E:\KTU\Softwares\MP lab\SPI\SPIwithUART\spislave.c"
;; Parameters:    Size  Location     Type
;;		None
;; Auto vars:     Size  Location     Type
;;		None
...
;; *************** function _delay *****************
;; Defined at:
;;		line 7 in file "E:\KTU\Softwares\MP lab\SPI\SPIwithUART\spislave.c"
;; Parameters:    Size  Location     Type
;;  del             2    0[COMMON] int 
;; Auto vars:     Size  Location     Type
;;		None
