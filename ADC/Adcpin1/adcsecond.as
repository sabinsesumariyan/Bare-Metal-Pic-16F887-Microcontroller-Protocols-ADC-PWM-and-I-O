...
;; *************** function _main *****************
;; Defined at:
;;		line 64 in file "E:\KTU\Softwares\MP lab\ADC\Adcsecond\adcsecond.c"
...
;;
psect	maintext
	file	"E:\KTU\Softwares\MP lab\ADC\Adcsecond\adcsecond.c"
	line	64
...
l2294:	
;adcsecond.c: 71: ANSEL=0X01;
	movlw	(01h)
	bsf	status, 5	;RP0=1, select bank3
	bsf	status, 6	;RP1=1, select bank3
	movwf	(392)^0180h	;volatile
	line	72
;adcsecond.c: 72: ANSELH=0X00;
...
l2302:	
;adcsecond.c: 78: for(int i=3;i>=0;i--)
	movlw	low(03h)
	movwf	(main@i)
	movlw	high(03h)
	movwf	((main@i))+1
...
l2308:	
;adcsecond.c: 79: {
;adcsecond.c: 80: address(0X80+i);
	movf	(main@i),w
	addlw	080h
	fcall	_address
	line	81
;adcsecond.c: 81: display(0X30+(tot%10));
	movlw	low(0Ah)
	movwf	(?___awmod)
	movlw	high(0Ah)
	movwf	((?___awmod))+1
...
;; *************** function _display *****************
;; Defined at:
;;		line 57 in file "E:\KTU\Softwares\MP lab\ADC\Adcsecond\adcsecond.c"
;; Parameters:    Size  Location     Type
...
l2276:	
;adcsecond.c: 58: RD0=1;
	bcf	status, 5	;RP0=0, select bank0
	bcf	status, 6	;RP1=0, select bank0
	bsf	(64/8),(64)&7
	line	59
;adcsecond.c: 59: RD1=0;
	bcf	(65/8),(65)&7
	line	60
	
l2278:	
;adcsecond.c: 60: PORTC=data;
	movf	(display@data),w
	movwf	(7)	;volatile
	line	61
	
l2280:	
;adcsecond.c: 61: pulse();
	fcall	_pulse
	line	62
...
;; *************** function _address *****************
;; Defined at:
;;		line 50 in file "E:\KTU\Softwares\MP lab\ADC\Adcsecond\adcsecond.c"
;; Parameters:    Size  Location     Type
;;  data            1    wreg     unsigned char 
;; Auto vars:     Size  Location     Type
;;  data            1    2[COMMON] unsigned char 
...
l2270:	
;adcsecond.c: 51: RD0=0;
	bcf	status, 5	;RP0=0, select bank0
	bcf	status, 6	;RP1=0, select bank0
	bcf	(64/8),(64)&7
	line	52
;adcsecond.c: 52: RD1=0;
	bcf	(65/8),(65)&7
	line	53
	
l2272:	
;adcsecond.c: 53: PORTC= data;
	movf	(address@data),w
	movwf	(7)	;volatile
	line	54
	
l2274:	
;adcsecond.c: 54: pulse();
	fcall	_pulse
	line	55
...
;; *************** function _type *****************
;; Defined at:
;;		line 43 in file "E:\KTU\Softwares\MP lab\ADC\Adcsecond\adcsecond.c"
;; Parameters:    Size  Location     Type
;;		None
;; Auto vars:     Size  Location     Type
;;		None
...
l2264:	
;adcsecond.c: 44: RD0=0;
	bcf	status, 5	;RP0=0, select bank0
	bcf	status, 6	;RP1=0, select bank0
	bcf	(64/8),(64)&7
	line	45
;adcsecond.c: 45: RD1=0;
	bcf	(65/8),(65)&7
	line	46
	
l2266:	
;adcsecond.c: 46: PORTC=0X38;
	movlw	(038h)
	movwf	(7)	;volatile
	line	47
	
l2268:	
;adcsecond.c: 47: pulse();
	fcall	_pulse
	line	48
...
;; *************** function _on *****************
;; Defined at:
;;		line 36 in file "E:\KTU\Softwares\MP lab\ADC\Adcsecond\adcsecond.c"
;; Parameters:    Size  Location     Type
;;		None
;; Auto vars:     Size  Location     Type
;;		None
...
l2258:	
;adcsecond.c: 37: RD0=0;
	bcf	status, 5	;RP0=0, select bank0
	bcf	status, 6	;RP1=0, select bank0
	bcf	(64/8),(64)&7
	line	38
;adcsecond.c: 38: RD1=0;
	bcf	(65/8),(65)&7
	line	39
	
l2260:	
;adcsecond.c: 39: PORTC=0X0E;
	movlw	(0Eh)
	movwf	(7)	;volatile
	line	40
	
l2262:	
;adcsecond.c: 40: pulse();
	fcall	_pulse
	line	41
...
;; *************** function _pulse *****************
;; Defined at:
;;		line 29 in file "E:\KTU\Softwares\MP lab\ADC\Adcsecond\adcsecond.c"
;; Parameters:    Size  Location     Type
;;		None
;; Auto vars:     Size  Location     Type
;;		None
...
l2256:	
;adcsecond.c: 32: RD2=0;
	bcf	status, 5	;RP0=0, select bank0
	bcf	status, 6	;RP1=0, select bank0
	bcf	(66/8),(66)&7
	line	33
;adcsecond.c: 33: delay(100);
	movlw	low(064h)
	movwf	(?_delay)
	movlw	high(064h)
	movwf	((?_delay))+1
...
;; *************** function _delay *****************
;; Defined at:
;;		line 25 in file "E:\KTU\Softwares\MP lab\ADC\Adcsecond\adcsecond.c"
;; Parameters:    Size  Location     Type
;;  del             2    0[COMMON] int 
;; Auto vars:     Size  Location     Type
;;		None
...
;; *************** function _adc *****************
;; Defined at:
;;		line 4 in file "E:\KTU\Softwares\MP lab\ADC\Adcsecond\adcsecond.c"
;; Parameters:    Size  Location     Type
;;		None
;; Auto vars:     Size  Location     Type
;;  low             2    4[COMMON] int 
...
l1456:	
;adcsecond.c: 5: int high,low;
;adcsecond.c: 6: ADCON0=0X83;
	movlw	(083h)
	bcf	status, 5	;RP0=0, select bank0
	bcf	status, 6	;RP1=0, select bank0
	movwf	(31)	;volatile
	line	7
;adcsecond.c: 7: ADCON1=0X80;
	movlw	(080h)
	bsf	status, 5	;RP0=1, select bank1
	bcf	status, 6	;RP1=0, select bank1
	movwf	(159)^080h	;volatile
	line	8
;adcsecond.c: 8: while(GO!=0);
	goto	l1027
